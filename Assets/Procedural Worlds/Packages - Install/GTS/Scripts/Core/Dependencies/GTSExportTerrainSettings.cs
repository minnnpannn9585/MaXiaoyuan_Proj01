...
namespace ProceduralWorlds.GTS
{
    ...
    [System.Serializable]
    public class GTSExportTerrainLODSettings
    {
        public SaveResolution m_saveResolution = SaveResolution.Half;
        public float m_simplifyQuality = 1.0f;
        public SimplificationOptions m_simplificationOptions = new SimplificationOptions()
        {
        ...
        public bool CompareTo(GTSExportTerrainLODSettings compareToLOD)
        {
    ...
    [System.Serializable]
    public class GTSExportTerrainSettings : ScriptableObject, ISerializationCallbackReceiver
    {
        ...
        public List<GTSExportTerrainLODSettings> m_exportTerrainLODSettingsSourceTerrains = new List<GTSExportTerrainLODSettings>();
        public List<GTSExportTerrainLODSettings> m_exportTerrainLODSettingsImpostors = new List<GTSExportTerrainLODSettings>();
...
#if GAIA_MESH_PRESENT
        public SimplificationOptions m_colliderSimplificationOptions = new SimplificationOptions()
        {
            PreserveBorderEdges = true,
            PreserveUVSeamEdges = false,
            PreserveUVFoldoverEdges = false,
        ...
        public bool CompareTo(GTSExportTerrainSettings compareSettings)
        {
        ...
        public static void SetLODToImpostorMode(GTSExportTerrainLODSettings lodSettings, int LODLevel)
        {
        ...
        public static void SetLODToLowPolyMode(GTSExportTerrainLODSettings lodSettings, int LODLevel)
        {
            lodSettings.namePrefix = "LOD" + LODLevel.ToString() + "_";
