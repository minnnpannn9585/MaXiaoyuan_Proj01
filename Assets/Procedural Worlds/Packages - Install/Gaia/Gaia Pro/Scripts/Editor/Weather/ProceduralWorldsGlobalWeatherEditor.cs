...
namespace Gaia
{
    ...
    public class ProceduralWorldsGlobalWeatherEditor : PWEditor
    {
        ...
        private void WindSettingsEnabled(bool helpEnabled)
        {
            ...
            EditorGUILayout.BeginHorizontal();
            m_globalWeather.WindDirection = m_editorUtils.Slider("WindDirection", m_globalWeather.WindDirection, 0f, 1f);
            if (m_globalWeather.WindDirection < 0.25f || m_globalWeather.WindDirection == 1)
            {
                EditorGUILayout.LabelField("N ", GUILayout.Width(30f));
            }
            else if (m_globalWeather.WindDirection > 0.25f && m_globalWeather.WindDirection < 0.5f)
            {
                EditorGUILayout.LabelField("E ", GUILayout.Width(30f));
            }
            else if (m_globalWeather.WindDirection > 0.5 && m_globalWeather.WindDirection < 0.75f)
            {
