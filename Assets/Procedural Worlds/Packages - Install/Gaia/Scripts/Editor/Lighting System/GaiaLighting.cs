...
namespace Gaia
{
    public static class GaiaLighting
    {
        ...
        private static void SetShadowSettings(GaiaLightingProfileValues profile)
        {
            ...
            GaiaURPRuntimeUtils.SetShadowDistance(GaiaUtils.GetRenderPipelineAsset() as UniversalRenderPipelineAsset, profile);
...
#region Utils
        ...
        {
            //#if GENA_PRO
            //            GaiaTimeOfDayLightSync[] lightSyncs = GaiaUtils.FindObjectsByTypeVersionFix<GaiaTimeOfDayLightSync>();
        ...
        public static void NewGlobalReflectionProbe(SceneProfile profile)
        {
            try
            {
                ...
                else
                {
                    ...
                    //Render Probe
                    if (probe.IsFinishedRendering(GaiaUtils.GetInstanceIdVersionFix(probe)))
                    {
                        probe.RenderProbe();
                    }
                }
