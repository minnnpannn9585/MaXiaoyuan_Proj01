...
namespace Gaia
{
    ...
    public static class GaiaSceneManagement
    {
        ...
        private static Vector3 RemoveGaiaControllers(string playerPrefabName, bool spawnAtLocation, GaiaSceneInfo sceneinfo, Camera customPlayerCamera, bool removeCamera = true)
        {
            ...
            if (removeCamera)
            {
                Camera[] cameras = GaiaUtils.FindObjectsByTypeVersionFix<Camera>();
        ...
        {
            GameObject playerPrefab = PWCommon7.AssetUtils.GetAssetPrefab(playerPrefabName);
            ...
            try
            {
                ...
                if (light != null)
                {
                    ...
                    if (lightData != null)
                    {
                        ...
                        profile.m_hDSunIntensity = GaiaHDRPRuntimeUtils.GetLightIntensity(light,lightData);
