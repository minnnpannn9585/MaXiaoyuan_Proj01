...
namespace Gaia.Pipeline.URP
{
    ...
    public static class GaiaURPPipelineUtils
    {
        ...
        {
#if UPPipeline
            UniversalRenderPipelineAsset pipelineAsset = GaiaUtils.GetRenderPipelineAsset() as UniversalRenderPipelineAsset;
        ...
        {
#if UPPipeline
            UniversalRenderPipelineAsset asset = GaiaUtils.GetRenderPipelineAsset() as UniversalRenderPipelineAsset;
            if (asset != null)
            {
                bool setDirty = false;
        ...
        private static void UpdateBiomePostFX()
        {
            try
            {
                GaiaPostProcessBiome[] gaiaPostProcessBiomes = GaiaUtils.FindObjectsByTypeVersionFix<GaiaPostProcessBiome>();
        ...
        public static void CleanUpURP(UnityPipelineProfile profile, GaiaSettings gaiaSettings)
        {
            ...
            {
#if UPPipeline
                UniversalAdditionalCameraData[] camerasData = GaiaUtils.FindObjectsByTypeVersionFix<UniversalAdditionalCameraData>();
                GaiaURPRuntimeUtils.ClearUPCameraData(camerasData);

                UniversalAdditionalLightData[] lightsData = GaiaUtils.FindObjectsByTypeVersionFix<UniversalAdditionalLightData>();
        ...
        private static void SetMotionBlurPostFX(bool enabled)
        {
            try
            {
                ...
                PostProcessVolume[] postProcessVolumes = GaiaUtils.FindObjectsByTypeVersionFix<PostProcessVolume>();
