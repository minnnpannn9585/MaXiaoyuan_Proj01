...
namespace Gaia
{
    ...
    public class GaiaSessionManagerEditor : PWEditor
    {
        ...
        private void DrawSummary(bool helpEnabled)
        {
...
#endif
                OrthographicBake.PrepareBakeTerrain(Terrain.activeTerrain, 2048, 2048, Camera.main.cullingMask, textureFileName);
            ...
            m_manager.m_recordSession = m_editorUtils.Toggle("RecordSession", m_manager.m_recordSession, helpEnabled);
