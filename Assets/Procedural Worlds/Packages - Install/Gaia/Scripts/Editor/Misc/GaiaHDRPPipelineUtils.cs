...
namespace Gaia.Pipeline.HDRP
{
    ...
    public static class GaiaHDRPPipelineUtils
    {
        ...
        public static void CleanUpHDRP(UnityPipelineProfile profile, GaiaSettings gaiaSettings)
        {
            ...
            {
#if HDPipeline
                HDAdditionalCameraData[] camerasData = GaiaUtils.FindObjectsByTypeVersionFix<HDAdditionalCameraData>();
                if (camerasData != null)
                {
                ...
                HDAdditionalLightData[] lightsData =GaiaUtils.FindObjectsByTypeVersionFix<HDAdditionalLightData>();
                if (lightsData != null)
                {
                ...
                HDAdditionalReflectionData[] reflectionsData = GaiaUtils.FindObjectsByTypeVersionFix<HDAdditionalReflectionData>();
