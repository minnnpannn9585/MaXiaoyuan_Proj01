...
namespace Gaia
{
    ...
    public class GWSetting : ScriptableObject, IComparable<GWSetting>
    {
        ...
        //Reason: should not affect the functionality of the Gaia Wizard setting if the settings below are kept between playmode changes
...
#pragma warning restore UDR0001
        ...
        {
            //can happen during rare race conditions
