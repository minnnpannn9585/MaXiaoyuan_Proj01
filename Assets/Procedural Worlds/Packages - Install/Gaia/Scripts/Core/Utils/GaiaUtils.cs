...
#region Asset, Scriptable Object, GameObject helpers
        ...
        private static void UpdateAllSceneProbes(ReflectionProbeData data)
        {
            ...
            ReflectionProbe[] probes = FindObjectsByTypeVersionFix<ReflectionProbe>();
            if (probes.Length > 0)
            {
        ...
        public static VolumeProfile GetVolumeProfile(bool isPlaying, string deepSearchName, string doesNotContain)
        {
            ...
            Volume[] volumes = GaiaUtils.FindObjectsByTypeVersionFix<Volume>();
        ...
        public static Light GetMainDirectionalLight(bool create = true, bool parent = true)
        {
            ...
            if (lightObject == null)
            {
                ...
                Light[] lights = GaiaUtils.FindObjectsByTypeVersionFix<Light>();
...
#region Image helpers
        ...
        public static void CompressToMultiChannelFileImage(float[,,] input, string imageName, TextureFormat imageStorageFormat = Gaia.GaiaConstants.defaultTextureFormat, bool flip = false, bool exportPNG = true, bool exportJPG = true)
        {
            ...
            for (int image = 0; image < images; image++)
            {
                ...
                if (exportJPG)
                {
                    ...
                    PWCommon7.Utils.WriteAllBytes(imageName + image + ".jpg", jpgBytes);
                }
                ...
                if (exportPNG)
                {
                    ...
                    PWCommon7.Utils.WriteAllBytes(imageName + image + ".png", pngBytes);
                }
        ...
        public static void CompressToMultiChannelFileImage(string imageName, HeightMap r, HeightMap g, HeightMap b, HeightMap a, TextureFormat imageStorageFormat, GaiaConstants.ImageFileType imageFileType, float baseLevel, GaiaConstants.GaiaProWaterReflectionsQuality textureResolution = GaiaProWaterReflectionsQuality.Resolution1024)
        {
            ...
            switch (imageFileType)
            {
                case GaiaConstants.ImageFileType.Jpg:
                    ...
                    PWCommon7.Utils.WriteAllBytes(imageName + ".jpg", jpgBytes);
                    break;
                case GaiaConstants.ImageFileType.Png:
                    byte[] pngBytes = ImageConversion.EncodeToPNG(exportTexture);
                    PWCommon7.Utils.WriteAllBytes(imageName + ".png", pngBytes);
                    break;
                case GaiaConstants.ImageFileType.Exr:
                    ...
                    PWCommon7.Utils.WriteAllBytes(imageName + ".exr", exrBytes);
                    break;
            }
        ...
        public static float[,] DecompressFromSingleChannelFileImage(string fileName, int width, int height, TextureFormat imageStorageFormat = Gaia.GaiaConstants.defaultTextureFormat, bool channelR = true, bool channelG = false, bool channelB = false, bool channelA = false)
        {
            ...
            {
                byte[] bytes = PWCommon7.Utils.ReadAllBytes(fileName);
        ...
        public static void ExportJPG(string fileName, Texture2D texture)
        {
            ...
            PWCommon7.Utils.WriteAllBytes(fileName + ".jpg", bytes);
        }
        ...
        public static void ExportPNG(string fileName, Texture2D texture)
        {
            ...
            PWCommon7.Utils.WriteAllBytes(fileName + ".png", bytes);
        }
...
#region Programming helpers
        ...
        public static GameObject GetPlayerObject(bool create = true, bool forceCreate = false)
        {
            GameObject gaiaObj = GameObject.Find(GaiaConstants.gaiaPlayerObject);
            if ((gaiaObj == null && create) || forceCreate)
            {
        ...
        {
            GameObject worldMapObj = GaiaUtils.FindObjectDeactivated(GaiaConstants.worldDesignerObject);
        ...
        //Unity Version independent FindObjectsByType
        public static T[] FindObjectsByTypeVersionFix<T>() where T : UnityEngine.Object
        {
        ...
        //Unity Version independent FindFirstObjectsByType
        public static T FindFirstObjectByTypeVersionFix<T>() where T : UnityEngine.Object
        {
#if UNITY_6000_4_OR_NEWER
        ...
        //Unity Version independent Instance ID
        
        public static int GetInstanceIdVersionFix(UnityEngine.Object obj)
        {
#if UNITY_6000_4_OR_NEWER
            //using the hashcode of the newer GetEntityId here as this seems to be closer to how 
            //the older Instance ID was used
        ...
        public static bool IsSameTexture(Texture2D tex1, Texture2D tex2, bool checkID = false)
        {
            ...
            {
#if UNITY_6000_4_OR_NEWER
                if (tex1.GetEntityId().GetHashCode() != tex2.GetEntityId().GetHashCode())
#else
        ...
        public static bool IsSameGameObject(GameObject go1, GameObject go2, bool checkID = false)
        {
            ...
            {
#if UNITY_6000_4_OR_NEWER
                if (go1.GetEntityId().GetHashCode() != go2.GetEntityId().GetHashCode())
#else
