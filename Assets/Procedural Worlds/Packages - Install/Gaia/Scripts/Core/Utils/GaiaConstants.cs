...
namespace Gaia
{
    public static class GaiaConstants
    {
        ...
        //Reason: all static variables in here are constants
#pragma warning disable UDR0001
        ...
        /// <summary>
        /// The three different workflow types when initially creating a new scene
        /// </summary>
        public enum TerrainCreationWorkflow { ManualWithStamper, WorldDesigner, IngestUpdateTerrains }
        ...
        /// </summary>
        public static readonly string defaultGOSpawnTarget = "Gaia Game Object Spawns";

        /// <summary>
        /// Name of the Game Object that holds all design time tools
        /// </summary>
        public static readonly string gaiaToolsObject = "Gaia Tools";

        /// <summary>
        /// Name of the Game Object that holds all polygon masks
        /// </summary>
        public static readonly string gaiaPolyMaskObject = "PolyMasks";

        /// <summary>
        /// Name of the Game Object that holds runtime objects such as water and lighting etc.
        /// </summary>
        public static readonly string gaiaRuntimeObject = "Gaia Runtime";

        /// <summary>
        /// Name of the Game Object that holds gaia stopwatch data
        /// </summary>
        public static readonly string gaiaStopWatchDataObject = "Gaia Stopwatch";

        /// <summary>
        /// Name of the Game Object that holds the gaia terrains if created in a single scene.
        /// </summary>
        public static readonly string gaiaTerrainObjects = "Gaia Terrains";

        /// <summary>
        /// Name of the Game Object that holds the gaia terrain exports from the Terrain Exporter
        /// </summary>
        public static readonly string gaiaTerrainExportObjects = "Gaia Terrain Exports";

        /// <summary>
        /// Name of the Game Object that controls the loading of terrains on demand.
        /// </summary>
        public static readonly string gaiaTerrainLoaderManagerObjects = "Terrain Loader Manager";

        /// <summary>
        /// Name of the Game Object that holds all player related stuff.
        /// </summary>
        public static readonly string gaiaPlayerObject = "Gaia Player";

        /// <summary>
        /// Name of the Game Object that holds temporary sessio.
        /// </summary>
        public static readonly string gaiaTempSessionToolsObject = "Temp Session Tools";

        /// <summary>
        /// Name of the Game Object that holds the Gaia Water.
        /// </summary>
        public static readonly string gaiaWaterObject = "Gaia Water";

        /// <summary>
        /// Name of the Game Object that holds the Gaia Lighting.
        /// </summary>
        public static readonly string gaiaLightingObject = "Gaia Lighting";


        /// <summary>
        /// Name of the PW Sky object for the Procedural Worlds Sky.
        /// </summary>
        public static readonly string pwSkyObject = "PW Sky";

        /// <summary>
        /// Name of the Game Object that holds the Gaia Audio.
        /// </summary>
        public static readonly string gaiaAudioObject = "Gaia Audio";

        /// <summary>
        /// Name of the World Map Game Object
        /// </summary>
        public static readonly string worldDesignerObject = "World Designer";

        /// <summary>
        /// Name of the World Map Game Object
        /// </summary>
        public static readonly string floraGlobalManagerObject = "Flora Global Manager";

        /// <summary>
        /// Name of the World Map Random Generator Object
        /// </summary>
        public static readonly string worldGenerator = "World Generator";

        /// <summary>
        /// Name of the World Biome Masks Object
        /// </summary>
        public static readonly string worldBiomeMasks = "World Biome Masks";

        /// <summary>
        /// Name of the World Map Stamper Object
        /// </summary>
        public static readonly string worldMapStamper = "World Map Stamper";

        /// <summary>
        /// Name of the World Map Temporary Tools Object
        /// </summary>
        public static readonly string worldTempTools = "World Map Temp Tools";

        /// <summary>
        /// Name of the Stamper that will display the preview on the local map
        /// </summary>
        public static readonly string worldMapLocalStamper = "Local Map Stamp Preview";


        /// <summary>
        /// Name of the Stamper that will display the preview on the world map
        /// </summary>
        public static readonly string worldMapWorldStamper = "World Map Stamp Preview";

        /// <summary>
        /// Prefix for the World Map Terrain Object
        /// </summary>
        public static readonly string worldMapTerrainPrefix = "World Map";

        /// <summary>
        /// Name of the Container object that contains the stamp tokens on the world map.
        /// </summary>
        public static readonly string worldMapStampTokenSpawnTarget = "Stamp Token";

        /// <summary>
        /// Name of the Water Surface Game Object for the Gaia Water.
        /// </summary>
        public static readonly string waterSurfaceObject = "Water Surface";
        public static readonly string gaiaUnderwaterMaterial = "Gaia Ocean Underwater";
        public static readonly string GaiaThunderObjectName = "Gaia Thunder";
        public static readonly string GaiaThunderPrefabName = "Gaia Thunder.prefab";

        /// <summary>
        /// Name of the Stamper Game Object.
        /// </summary>
        public static readonly string StamperObject = "Stamper";

        /// <summary>
        /// Name of the Gaia Weather Game Object.
        /// </summary>
        public static readonly string gaiaWeatherObject = "Gaia Weather";

        public static readonly string gaiaPlanarReflections = "Gaia Planar Reflections";
        public static readonly string gaiaHDRPPlanarReflections = "Gaia HDRP Planar Reflections";

        public static readonly string gaiaPlanarReflectionsCamera = "Gaia Planar Reflections Camera";

        public static readonly string gaiaFileFormatAsset = ".asset";

        /// <summary>
        /// Name of the Maintenance Token object that triggers a maintenance run if present in the Data directory
        /// </summary>
        public static readonly string maintenanceTokenFilename = "MaintenanceToken.dat";

        /// <summary>
        /// Name of the FlyCam Player
        /// </summary>
        public static readonly string playerFlyCamName = "FlyCam";

        /// <summary>
        /// Name of the First Person Player
        /// </summary>
        public static readonly string playerFirstPersonName = "FPSController";

        /// <summary>
        /// Name of the XRPlayer
        /// </summary>
        public static readonly string playerXRName = "XRController";

        /// <summary>
        /// Name of the car controller
        /// </summary>
        public static readonly string m_carPlayerPrefabName = "Gaia Car";


        /// <summary>
        /// Name of the Third Person Player
        /// </summary>
        public static readonly string playerThirdPersonName = "ThirdPersonController";

        public static readonly string underwaterTransitionObjectName = "Underwater Transition Post Processing";

        public static readonly string underwaterPostProcessingName = "Underwater Post Processing";

        public static readonly string underwaterHorizonName = "Underwater Horizon";

        public static readonly string underwaterEffectsName = "Underwater Effects";

        public static readonly string lightingSettingsName = "Gaia Lighting Settings.asset";

        public static readonly string newSpawnRuleName = "New Spawn Rule";

        public static readonly string SourceTerrainBackupObject = "Source Terrain Backup";

        /// <summary>
        /// Name of the Label used to identify all the spawners that should appear in the Gaia Manager
        /// </summary>
        public static readonly string gaiaManagerSpawnerLabel = "GaiaManagerSpawner";

        /// <summary>
        /// Name of the loading screen prefab object
        /// </summary>
        public static readonly string loadingScreenName = "Gaia Loading Screen";
        ...
        /// </summary>
        public static readonly string GaiaNewsURL = "https://www.procedural-worlds.com/unity-asset-news/gaia/";

        /// <summary>
        /// URL for Gaia Pro News messages
        /// </summary>
        public static readonly string GaiaProNewsURL = "https://www.procedural-worlds.com/unity-asset-news/gaia-pro/";

        /// <summary>
        /// Prefix for LOD'ed Mesh Terrains created by the terrain exporter
        /// </summary>
        public static readonly string MeshTerrainLODGroupPrefix = "LODMesh";


        /// <summary>
        /// Official Name for a Mesh terrain - used on the Game Object, scene paths, etc.
        /// </summary>
        public static readonly string MeshTerrainName = "Mesh Terrains";

        /// <summary>
        /// Official Name for the impostor terrain - used on the Game Object, scene paths, etc.
        /// </summary>
        public static readonly string ImpostorTerrainName = "Impostor";

        /// <summary>
        /// Name for the directional light game object used in orthographic bakes
        /// </summary>
        public static readonly string BakeDirectionalLight = "OrthoBakeLight";

        /// <summary>
        /// Name for the volume game object used in orthographic bakes
        /// </summary>
        public static readonly string BakeVolume = "OrthoBakeVolume";

        /// <summary>
        /// Name for the Gaia Screenshotter object
        /// </summary>
        public static readonly string gaiaScreenshotter = "Screen Shotter";

        /// <summary>
        /// Name for the Game Object to collect the trees converted into Game Objects under
        /// </summary>
        public static readonly string gameObjectTreeContainer = "Converted Trees";
        ...
        /// </summary>
        public static readonly string TerrainLoadingSettingsHighlightColor = "ffa100cc";
