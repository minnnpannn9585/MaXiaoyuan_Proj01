...
namespace Gaia
{
    ...
    public class OrthographicBake
    {
        ...
        //Reason: The static fields in here are used to keep references to lights etc. during orthographic bake, which are then reset as needed when the next bake begins
