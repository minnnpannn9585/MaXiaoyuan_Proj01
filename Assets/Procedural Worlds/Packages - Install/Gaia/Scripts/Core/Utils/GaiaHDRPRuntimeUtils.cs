...
namespace Gaia.Pipeline.HDRP
{
    public static class GaiaHDRPRuntimeUtils
    {
        ...
        public static void SetupDefaultHDRPSunLight(Light light = null)
        {
            ...
            if (light != null)
            {
                ...
                if (data != null)
                {
                    ...
                    GaiaHDRPRuntimeUtils.SetLightUnit(light, data, LightUnit.Lux);
                    GaiaHDRPRuntimeUtils.SetLightIntensity(light, data, 70000f);
        ...
        {
            ReflectionProbe[] reflectionProbes = GaiaUtils.FindObjectsByTypeVersionFix<ReflectionProbe>();
        ...
        /// <summary>
        /// Gets the light unit for a light in HDRP depending on the unity version.
        /// </summary>
        /// <param name="light"></param>
        /// <param name="hdrpLightData"></param>
        public static LightUnit GetLightUnit(Light light, HDAdditionalLightData hdrpLightData)
        {
#if UNITY_6000_0_OR_NEWER
            return light.lightUnit;
#else
            return hdrpLightData.lightUnit;
#endif
        }

        /// <summary>
        /// Sets the light unit for a light in HDRP depending on the unity version.
        /// </summary>
        /// <param name="light"></param>
        /// <param name="hdrpLightData"></param>
        /// <param name="value"></param>
        public static void SetLightUnit(Light light, HDAdditionalLightData hdrpLightData, LightUnit unit)
        {
#if UNITY_6000_0_OR_NEWER
            light.lightUnit = unit;
#else
            hdrpLightData.lightUnit = unit;
#endif
        }

        /// <summary>
        /// Sets the light intensity for a light in HDRP depending on the unity version.
        /// </summary>
        /// <param name="light"></param>
        /// <param name="hdrpLightData"></param>
        /// <param name="value"></param>
        public static void SetLightIntensity(Light light, HDAdditionalLightData hdrpLightData, float value)
        {
#if UNITY_6000_0_OR_NEWER
            light.intensity = value;
#else
            hdrpLightData.SetIntensity(value);
#endif
        }

        /// <summary>
        /// Gets the light intensity for a light in HDRP depending on the unity version.
        /// </summary>
        /// <param name="light"></param>
        /// <param name="hdrpLightData"></param>
        public static float GetLightIntensity(Light light, HDAdditionalLightData hdrpLightData)
        {
#if UNITY_6000_0_OR_NEWER
            return light.intensity;
#else
            return hdrpLightData.intensity;
#endif
        }
#endif
