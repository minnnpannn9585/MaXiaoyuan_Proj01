...
#region URP
        ...
        {
            UniversalRenderPipelineAsset asset = (UniversalRenderPipelineAsset)GaiaUtils.GetRenderPipelineAsset();
            if (asset != null)
            {
        ...
        public static void GetUnitySunSettingsHDRP(out float intensity, out Color sunColor, out float kelvin, Light sunLight = null)
        {
            ...
            if (sunLight == null)
            {
                ...
                if (sunLight != null)
                {
                    ...
                    intensity = GaiaHDRPRuntimeUtils.GetLightIntensity(sunLight,data);
        ...
        public static void SetUnitySunSettingsHDRP(float intensity, float kelvin, Light sunLight = null)
        {
            if (sunLight == null)
            {
                ...
                if (sunLight != null)
                {
                    ...
                    GaiaHDRPRuntimeUtils.SetLightIntensity(sunLight, data, intensity);
...
#region Gaia Post Processing
        ...
        public static void SetDepthOfFieldSettings(PhotoModeValues photoModeProfile)
        {
            ...
            PostProcessVolume[] volumes = GaiaUtils.FindObjectsByTypeVersionFix<PostProcessVolume>();
