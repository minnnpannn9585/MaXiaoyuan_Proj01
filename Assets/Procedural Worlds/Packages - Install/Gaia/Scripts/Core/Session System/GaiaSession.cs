...
namespace Gaia
{
    ...
    //    {
    //        return PWCommon7.Utils.FixFileName(sessionName) + "_" + Path.GetFileName(m_fileName);
    //    }
    ...
    //    {
    //        return PWCommon7.Utils.FixFileName(sessionName) + "_" + Path.GetFileName(soFileName);
    //    }
    ...
    public class GaiaSession : ScriptableObject
    {
        ...
        {
            return PWCommon7.Utils.FixFileName(m_name);
        }
