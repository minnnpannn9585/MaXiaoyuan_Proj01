...
#pragma warning restore UDR0001
            ...
            if (WeatherPresent)
            {
                ...
                if (WeatherSystem.CheckIsNight())
                {
                    ...
                    if (m_sunLightExists)
                    {
                        ...
                        GaiaHDRPRuntimeUtils.SetLightIntensity(m_sunLight,SunHDLightData,0);
                        GaiaHDRPRuntimeUtils.SetLightUnit(m_sunLight, SunHDLightData, LightUnit.Lux);
#endif
                ...
                else
                {
                    if (m_moonLightExists)
                    {
                        ...
                        GaiaHDRPRuntimeUtils.SetLightIntensity(m_moonLight, MoonHDLightData, 0);
                        GaiaHDRPRuntimeUtils.SetLightUnit(m_moonLight, MoonHDLightData, LightUnit.Lux);
#endif
        ...
        public static float GetTimeOfDayMainValue()
        {
            float value = 0;
#if GAIA_2023_PRO
            value = ((GaiaAPI.GetTimeOfDayHour() * 60f) + GaiaAPI.GetTimeOfDayMinute()) / 1440f;
#endif
            return value;
        }
        /// <summary>
        ...
        public static void FinalizeCameraObjectRuntime(Camera cameraObject, bool closePhotoMode)
        {
            ...
            FollowPlayerSystem[] followPlayerSystems = GaiaUtils.FindObjectsByTypeVersionFix<FollowPlayerSystem>();
