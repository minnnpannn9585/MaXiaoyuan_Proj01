...
namespace Gaia
{
    ...
    /// </summary>
    public enum BakedMaskTypeInternal { RadiusTree=0, RadiusTag=1, WorldBiomeMask=2, LayerGameObject=3, LayerTree=4, PolyMask = 5 }
    [System.Serializable]
    public class CollisionMask
    {
        ...
        //Reason: those static arrays will be refreshed by Gaia when needed, they do not need to be reset when starting / stopping playmode
