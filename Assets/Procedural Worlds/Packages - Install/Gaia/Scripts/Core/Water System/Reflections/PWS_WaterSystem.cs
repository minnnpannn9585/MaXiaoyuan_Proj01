...
#pragma warning restore UDR0001
        ...
        private void CreateTexture()
        {
            ...
            if (m_RenderCamera.allowHDR)
            {
                ...
                {
                    name = m_reflectionName + GaiaUtils.GetInstanceIdVersionFix(this),
                    isPowerOfTwo = true
                };
            }
            else
                ...
                case GaiaConstants.EnvironmentRenderer.BuiltIn:
                    {
                        ...
                        {
                            GameObject MirrorGameObject = new GameObject(m_reflectionIDName + GaiaUtils.GetInstanceIdVersionFix(this) + m_forText + GaiaUtils.GetInstanceIdVersionFix(m_RenderCamera), typeof(Camera));
