...
namespace Gaia
{
    ...
    public class ResourceProtoTree
    {
        ...
        public enum GaiaNavMeshLOD
        {
            First,
            Last,
            Custom
        }
        [Tooltip("The LOD index to use for the NavMesh representation of this tree prototype.")]
        public GaiaNavMeshLOD m_navMeshLOD = GaiaNavMeshLOD.First;
        [Tooltip("The custom LOD index to use for the NavMesh representation of this tree prototype.")]
        public int m_customNavMeshLOD = 0;
